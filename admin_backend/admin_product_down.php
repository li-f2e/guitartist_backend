...
<?php
  ...
  if(!empty($modalType) ){
      ...
      $sql_total = "SELECT COUNT(1) FROM `product` WHERE `product_model` = '$modalType' AND `product_out` = '1'";
      ...
      $sql = sprintf( "SELECT * FROM `product` WHERE `product_model` = '$modalType' AND `product_out` = '1' ORDER BY `product_id` DESC LIMIT %s, %s " , 
  ...
  elseif(!empty($brand) ){
      $sql_total = "SELECT COUNT(1) FROM `product` WHERE `product_brand` = '$brand' AND `product_out` = '1' ";
      ...
      $sql = sprintf( "SELECT * FROM `product` WHERE `product_brand` = '$brand' AND `product_out` = '1' ORDER BY `product_id` DESC LIMIT %s, %s " , 
          ($page-1)*$perPage, $perPage );
      $stmt = $pdo->query($sql);
  ...
  elseif(!empty($quantity) ){
      ...
      $sql_total = "SELECT COUNT(1) FROM `product` WHERE `product_quantity` < '$quantity' AND `product_out` = '1'";
      $totalRows = $pdo->query($sql_total)->fetch(PDO::FETCH_NUM)[0];
      $totalPages = ceil( $totalRows/$perPage);
      ...
      $sql = sprintf( "SELECT * FROM `product` WHERE `product_quantity` < '$quantity' AND `product_out` = '1' ORDER BY `product_id` DESC LIMIT %s, %s " , 
          ($page-1)*$perPage, $perPage );
      $stmt = $pdo->query($sql);
  ...
  elseif(!empty($cutaway) ){
      ...
      $sql_total = "SELECT COUNT(1) FROM `product` WHERE `product_cutaway` = '$cutaway' AND `product_out` = '1'";
      $totalRows = $pdo->query($sql_total)->fetch(PDO::FETCH_NUM)[0];
      $totalPages = ceil( $totalRows/$perPage);
      ...
      $sql = sprintf( "SELECT * FROM `product` WHERE `product_cutaway` = '$cutaway' AND `product_out` = '1' ORDER BY `product_id` DESC LIMIT %s, %s " , 
          ($page-1)*$perPage, $perPage );
      $stmt = $pdo->query($sql);
...
<script>
        ...
        function selectCategory(element_id, selection){
            ...
            window.location.href= `admin_product_down.php?${selection}=${selectValue}`;
        }

        function lowQuantity(column, quantity){
            window.location.href= `admin_product_down.php?${column}=${quantity}`;
        }

        function showCutaway(){
            window.location.href= `admin_product_down.php?cutaway=1`;
        }
