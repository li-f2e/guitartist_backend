        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                ...
                <form name="form1" onsubmit="return checkForm()" >
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <form name="form1" method="post" enctype="multipart/form-data">
                                    <img src="uploads/<?=$row['pic']?>" alt="" class="" id="hall_pic_pre"  style="width:50%;">
                            ...
                            <tr>
                                <th>詳細地址</th>
                                <td class="d-flex">
                                    <input type="text" name="addr_district" id="addr_district" value="<?=$row['addr_district']?>">
                        ...
                        <a href="admin_hall_list.php"><div type="" class="btn btn-light" id="">取消 </div></a>
