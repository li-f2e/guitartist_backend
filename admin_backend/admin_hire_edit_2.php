                  ...
                  <div class="card-body card-body-css">
                    ...
                    <form name="form1" onsubmit="return checkForm()">
                      ...
                      <table class="table table-hover">
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <div>
                              <input type="<?=!empty($row['alt_tel']) ? 'text' : 'hidden'?>" name="alt_tel" id="alt_tel"
                                class="mt-1" value="<?=htmlentities($row['alt_tel'])?>" />
                      ...
                      <div class="mr-auto mt-4 d-flex" style="width:130px">
                        ...
                        <a name="" id="" class="btn btn-light ml-2" href="admin_hire_info.php" role="button">返回</a>
                      </div>
                    </form>
                  </div>
                </div>
...
<script>
  ...
  function checkForm() {
    ...
    if (isPass) {
      fetch("admin_hire_edit_api_2.php", {
        method: "POST",
        body: fd
      })
        .then(response => {
