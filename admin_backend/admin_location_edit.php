...
<div class="wrapper d-flex">
    ...
    <div class="mainContent mainContent-css">
                            ...
                            <h2 class="card-title" style="text-align:center;">修改場地資訊</h2>
                               ...
                               <form name="form1" onsubmit="return checkForm()">
                                    ...
                                    <div class="form-group">                                                                                                
                                        ...
                                        <input type="checkbox" name="open-day[]" value="9點到12點"   checked="<?= empty($row['open-day']) ? $row['open-day'] : '' ?>"/>9點到12點<br />
                                        <input type="checkbox" name="open-day[]" value="13點到17點"  checked="<?= empty($row['open-day']) ? $row['open-day'] : '' ?>"/>13點到17點<br />
                                        <input type="checkbox" name="open-day[]" value="18點到21點"  checked="<?= empty($row['open-day']) ? $row['open-day'] : '' ?>"/>18點到21點<br />
                                        <small id="location-priceHelp" class="form-text"></small>
                                    </div>
        ...
        function checkForm() {
            ...
            fetch('admin_location_edit_api.php', {
                    method: 'POST',
                    body: fd,
                })
                .then(response => {
...
<?php include __DIR__ . '/admin___footer.php' ?>