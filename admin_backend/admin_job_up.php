...
$t_sql = "SELECT COUNT(1) FROM `job_list` WHERE `job_out`='0'  ";
...
$sql = "SELECT * FROM `job_list` WHERE `job_out` = '0' ";

// $sql = sprintf("SELECT * FROM job_list WHERE `job_out` = '0'  ORDER BY `sid` DESC LIMIT %s, %s",
//         ($page-1)*$per_page,
//             $per_page
// );
